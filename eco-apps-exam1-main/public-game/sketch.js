...
// recibo los eventos que me estan enviado desde el servidor e igualo el mensaje que estoy recibiendo para poder utilizarlo en esta parte del codigo.
...
async function sendScore(point) {
    let message = {content: "You scores a point"};
    let request = {
    method: "POST",
    headers: {
        "Content-Type" : ""
...
fetch('http://localhost:8080/startgame',request);
}
